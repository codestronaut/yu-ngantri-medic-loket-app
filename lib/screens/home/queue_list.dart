...
import 'package:yu_ngantri_medic_loket_app/service/notification.dart';
...
class _QueueListState extends State<QueueList> {
  ...
  _getUserData() async {
    await Firestore.instance
        ...
        .then((value) {
      setState(() {
        counterNumber = value.data['counter_number'];
                ...
                onPressed: isDisable
                    ...
                    : () async {
                        ...
                        Firestore.instance
                          ...
                          'counter_number': 'Loket ' + tellerName,
                        });
